        ...
        <div className="footer-content">
          <div className="footer-brand">
            ...
            <div className="social-links">
              ...
              <a href="https://www.instagram.com/indiatourguide_" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
          ...
          <div className="footer-contact">
            ...
            <ul>
              ...
              <li>{t('footer.instagram', { defaultValue: 'Instagram' })}: <a href="https://www.instagram.com/indiatourguide_" target="_blank" rel="noopener noreferrer">{t('footer.followOnInstagram', { defaultValue: 'Follow us on Instagram' })}</a></li>
